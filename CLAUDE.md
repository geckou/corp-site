...
- `.claude/docs/architecture.md` — API方針、Firebase使い分け、認証、データ取得、環境変数、Zustand、Storage、FCM、Sentry、i18n、RevenueCat、コンポーネント整理
- `.claude/docs/git-workflow.md` — リリースフロー詳細、マルチ環境構成
