...
export const Facts = ({ isActivated, heading }: FactsProps) => {
  ...
  return (
    <SectionContainer className="flex items-end justify-end p-sp-max max-sm:p-sp-large">
      <dl className="facts-list z-contents flex flex-col text-right leading-[1.7]">
        {FACTS.map((fact) => (
