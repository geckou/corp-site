...
export const ServicesDevelopment = ({
  ...
  const angleValues =
    mediaDevice === 'mobile'
      ? {
          left: { angleValue: -30, topEdgeWidth: 120 },
          right: { angleValue: 10, topEdgeWidth: 500 },
        }
      : {
          left: { angleValue: -55, topEdgeWidth: 500 },
          right: { angleValue: 15, topEdgeWidth: 1000 },
        }

  const bgImageSrc =
    mediaDevice === 'mobile'
      ? '/images/development_mobile.webp'
      ...
      <ServiceItem
        ...
        description={
          <>
            ...
            <br />
            <span>
              Webアプリ、ECサイトなどアイディアの実現や、既存システムを改良した業務の効率化など、
            </span>
